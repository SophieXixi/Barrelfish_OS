 ...
 * @return SYS_ERR_OK on sucecss, LIB_ERR_* on failure.
 */
static inline errval_t paging_map_frame_attr(struct paging_state *st, void **buf,
 ...
 */
errval_t paging_map_fixed_attr_offset(struct paging_state *st, lvaddr_t vaddr,
