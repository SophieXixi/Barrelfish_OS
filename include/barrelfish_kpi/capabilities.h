...
STATIC_ASSERT((L2_CNODE_SLOTS * (1UL << OBJBITS_CTE)) == OBJSIZE_L2CNODE, "l2 cnode size doesn't "
                                                                          "match cte size");
...
static inline bool type_is_vnode(enum objtype type)
{
    ...
    return (type == ObjType_VNode_VTd_root_table || type == ObjType_VNode_VTd_ctxt_table
...
static inline bool type_is_ept(enum objtype type)
{
    ...
    return (type == ObjType_VNode_x86_64_ept_pml4 || type == ObjType_VNode_x86_64_ept_pdpt
            || type == ObjType_VNode_x86_64_ept_pdir || type == ObjType_VNode_x86_64_ept_ptable);
}
